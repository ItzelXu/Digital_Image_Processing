...
\begin{figure}[!htp]
	\centering
	\includegraphics[scale=0.2]{river1_largest.png}
	\caption{ The position of $\vct {kp}_1$}
	\label{river1_largest}
	\end{figure}
...
\end{equation}
Where $\vct {kp}^{ ' }$ is the key-point of {\it river2.raw}. The $x_1,x_2...x_D$ are $D = 128$ features of the descriptor, i.e. the 128 entries in a row of the descriptor.\par
The key-point with the shortest $L2$ norm distance is regardest as the closest neighboring key-point of $\vct {kp}_1$. 
I try several number of nearest neighbour and the result are shown in the next section.
...
{
	\centering          
	\includegraphics[scale=2]{zero_1_kp.png}   
}
	\qquad
\subfloat[zero\_2] 
{
	\centering      
	\includegraphics[scale=2]{zero_2_kp.png}   
}
 \qquad
\subfloat[zero\_3] 
{
	\centering      
	\includegraphics[scale=2]{zero_3_kp.png}   
}
 \qquad
\subfloat[zero\_4] 
{
	\centering      
	\includegraphics[scale=2]{zero_4_kp.png}   
}
 \qquad
\subfloat[zero\_5] 
{
%	\centering      
	\includegraphics[scale=2]{zero_5_kp.png}   
}
